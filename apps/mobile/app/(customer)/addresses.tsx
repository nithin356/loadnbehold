    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: c.background }}>
      ...
      <ScrollView style={{ flex: 1 }} contentContainerStyle={{ padding: spacing.xl }}>
        ...
        {showForm && (
          <View style={{ backgroundColor: c.surface, borderRadius: radius.lg, borderWidth: 1, borderColor: c.brand, padding: spacing.lg, marginBottom: spacing.lg }}>
            ...
            {[
              ...
              { placeholder: 'ZIP Code', value: zip, setter: setZip, keyboard: 'number-pad' as const },
        ...
        {addresses.length === 0 && !showForm ? (
          ...
          addresses.map((addr) => (
            <View key={addr._id} style={{ flexDirection: 'row', alignItems: 'center', padding: spacing.md, backgroundColor: c.surface, borderRadius: radius.lg, borderWidth: 1, borderColor: c.border, marginBottom: spacing.sm }}>
              ...
              <View style={{ flex: 1 }}>
                ...
                {addr.instructions && <Text style={{ fontSize: fontSize.xs, color: c.textTertiary, fontStyle: 'italic' }}>{addr.instructions}</Text>}
              </View>
