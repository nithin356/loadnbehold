...
async function seed() {
      ...
      subscriptionPlans: [
        {
          ...
          name: 'Basic',
          price: 0,
          perks: ['Standard delivery', 'Email support'],
          discountPercent: 0,
          familySlots: 0,
          loyaltyMultiplier: 1,
          isActive: true,
  ...
  const driver1 = await Driver.findOneAndUpdate(
    { userId: driverUser1._id },
    {
      ...
      status: 'approved',
      isOnline: true,
      vehicle: { type: 'car', make: 'Toyota', model: 'Camry', plate: 'MI-1234', color: 'Silver' },
  ...
  const driver2 = await Driver.findOneAndUpdate(
    { userId: driverUser2._id },
    {
      ...
      status: 'approved',
      isOnline: false,
      vehicle: { type: 'car', make: 'Honda', model: 'Civic', plate: 'MI-5678', color: 'Black' },
      assignedOutlet: outlet._id,
